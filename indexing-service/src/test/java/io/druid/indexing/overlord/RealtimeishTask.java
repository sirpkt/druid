...
public class RealtimeishTask extends AbstractTask
{
  ...
  public TaskStatus run(TaskToolbox toolbox) throws Exception
  {
    ...
    final TaskLock lock1 = toolbox.getTaskActionClient().submit(new LockAcquireAction(interval1, null));
    ...
    final TaskLock lock2 = toolbox.getTaskActionClient().submit(new LockAcquireAction(interval2, null));
