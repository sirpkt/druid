...
public class OnheapIncrementalIndex extends IncrementalIndex<Aggregator>
{
  ...
  {
    return new OnHeapDimDim(dimension);
  }
  ...
  private static class OnHeapDimDim<T extends Comparable<T>> implements DimDim<T>
  {
    ...
    {
      T prev = poorMansInterning.putIfAbsent(value, value);
