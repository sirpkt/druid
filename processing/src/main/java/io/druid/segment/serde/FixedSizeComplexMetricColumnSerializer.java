...
public class FixedSizeComplexMetricColumnSerializer implements MetricColumnSerializer
{
  ...
  public FixedSizeComplexMetricColumnSerializer(
      String metricName,
      File outDir,
      IOPeon ioPeon,
  ...
  public void open() throws IOException
  {
    writer = CompressedFixedSizeObjectSupplierSerializer.create(
        ioPeon,
        String.format("%s_%s", metricName, outDir.getName()),
        IndexIO.BYTE_ORDER,
