...
{
  private final Map lookupMap = ImmutableMap.<Comparable, Comparable>of("foo", "bar", "null", "", "empty String", "", "","empty_string");
  private final MapLookupExtractor fn = new MapLookupExtractor(lookupMap, "string");
  ...
  {
    final MapLookupExtractor fn2 = new MapLookupExtractor(ImmutableMap.copyOf(lookupMap), "string");
    Assert.assertArrayEquals(fn.getCacheKey(), fn2.getCacheKey());
    final MapLookupExtractor fn3 = new MapLookupExtractor(ImmutableMap.<Comparable, Comparable>of("foo2", "bar"), "string");
    Assert.assertFalse(Arrays.equals(fn.getCacheKey(), fn3.getCacheKey()));
    final MapLookupExtractor fn4 = new MapLookupExtractor(ImmutableMap.<Comparable, Comparable>of("foo", "bar2"), "string");
